...
export default class Index extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      modalShowRegistrarLivro: false,
      modalShowGerenciarLivro: false,
      modalShowAssociarAluno: false,
      success: "",
      error: "",
  ...
  setModalShowRegistrarHistoricoAluno(valor) {
    this.setState({
      modalShowRegistrarHistoricoAluno: valor,
      success: "",
      error: "",
    });
  }
  ...
  setModalShowRegistrarLivro(valor) {
    this.setState({
      modalShowRegistrarLivro: valor,
      success: "",
      error: "",
    });
  }

  handlerShowModalRegistrarLivro() {
    this.setModalShowRegistrarLivro(true);
  }

  handlerCloseModalRegistrarLivro() {
    this.setModalShowRegistrarLivro(false);
  }

  setModalShowGerenciarLivro(valor) {
    this.setState({
      modalShowGerenciarLivro: valor,
      success: "",
      error: "",
    });
  }

  handlerShowModalGerenciarLivro() {
    this.setModalShowGerenciarLivro(true);
  }

  handlerCloseModalGerenciarLivro() {
    this.setModalShowGerenciarLivro(false);
  }

  setModalShowAssociarAluno(valor) {
    this.setState({
      modalShowAssociarAluno: valor,
      success: "",
      error: "",
    });
  }

  handlerShowModalAssociarAluno() {
    this.setModalShowAssociarAluno(true);
  }

  handlerCloseModalAssociarAluno() {
    this.setModalShowAssociarAluno(false);
  }
  ...
  listaDeComponentesCurriculares = async (token, idAreaConhecimento) => {
    ...
    try {
      const response = await fetch(
        `${api.baseURL}/areas_conhecimento/${idAreaConhecimento}/componente_curricular`,
        {
          method: "GET",
          headers: {
            Accept: "application/json",
  ...
  buscarHistoricoEscolar = async (token, idAluno) => {
    try {
      const response = await fetch(
        `${api.baseURL}/alunos/${idAluno}/historico_escolar`,
        {
          method: "GET",
          headers: {
            Accept: "application/json",
  ...
  componentesCurricularesEsuasDiciplinas = (
    ac,
    cc,
    nM1,
    nM2,
      ...
      <>
        <Navbar fixed style={{ backgroundColor: "#eaeaea" }}>
          <Container>
            <Navbar.Brand href="#home">
              <img id="logo" src={logo} style={{ width: "100px" }} />
            </Navbar.Brand>
            <Nav className="ml-auto">
              ...
              <Nav.Link>
                <button
                  className="button"
                  onClick={() => this.handlerShowModalRegistrarLivro()}
                >
                  Registrar Livro
                </button>
              </Nav.Link>
            ...
            <Col md={12}>
              <Accordion defaultActiveKey="0" className="mt-3 mb-5">
                <Accordion.Item eventKey="0">
                  .
                  <Accordion.Header>
                    <FaUserGraduate /> Gerenciar Alunos - Total:{" "}
                    {arrayAlunos.length}
                  </Accordion.Header>
                  <Accordion.Body>
                    <Container fluid>
                      <div className="d-flex justify-content-center text-center">
                        <div className="mb-3">
                          <label htmlFor="lista_alunos" className="form-label">
                          ...
                          <input
                            ...
                            type="file"
                            id="lista_alunos"
                            onChange={this.importarListaDeAlunos}
                            accept=".xlsx"
                            onClick={(e) => {
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <button
                                        ...
                                        size="sm"
                                        onClick={() =>
                                          this.handlerShowModalHistoricoAluno(
                                            aluno
                                          )
                                        }
                                      >
                  ...
                  <Accordion.Body>
                    <div class="table-wrapper">
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            <td className="align-middle">Livro1</td>
                            <td className="align-middle">34</td>
                            <td className="align-middle">14/11/2023 - 13:18</td>
                            <td>
                              <button
                                className="button w-100"
                                onClick={() =>
                                  this.handlerShowModalGerenciarLivro()
                                }
                              >
                                Atualizar
                              </button>
        ...
        >
          ...
          <Modal.Body>
            <Container>
              <h4>
                <FaUserGraduate /> Atualizar Informações do Aluno
              </h4>
              <hr />
              ...
              <Stack direction="horizontal" gap={3}>
                ...
                <div className="p-2 ms-auto">
                  <button
                    ...
                    size="sm"
                    onClick={() =>
                      this.handlerShowModalRegistrarHistoricoAluno()
                    }
                  >
                    Registrar Histórico
                  </button>
              ...
              <Table bordered>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colSpan={3}>
                      Data de Expedição: {this.state.dt_exp_formatada}
                    </td>
                  </tr>
                  <tr>
                    <td colSpan={3}>
                      Data de Nascimento: {this.state.dt_nascimento_formatada}
                    </td>
                    <td colSpan={6}>
                ...
                <tbody>
                  {arrayHistoricoEscolar.length > 0
                    ? arrayHistoricoEscolar.map((item) => {
                        ...
                        return this.componentesCurricularesEsuasDiciplinas(
                          item.ac,
                          cc,
                          nM1,
                          nM2,
          ...
          <Modal.Body>
            <Form onSubmit={this.cadastrarHistoricoEscolar}>
              ...
              <Form.Select
                ...
                onChange={(e) =>
                  this.listaDeComponentesCurriculares(
                    getToken(),
                    e.target.value
                  )
                }
              ...
              <Form.Select
                ...
                aria-label="Default select example"
                onChange={(e) =>
                  this.setState({ idComponenteCurricular: e.target.value })
                }
              >
                <option>Selecione</option>
                ...
                <Col>
                  <div className="form-group">
                    ...
                    <InputMask
                      ...
                      onChange={(e) =>
                        this.setState({ notaModulo1: e.target.value })
                      }
                    />
                  </div>
                </Col>
                <Col>
                  <div className="form-group">
                    ...
                    <InputMask
                      ...
                      onChange={(e) =>
                        this.setState({ chModulo1: e.target.value })
                      }
                    />
                  </div>
                </Col>
                ...
                <Col>
                  <div className="form-group">
                    ...
                    <InputMask
                      ...
                      onChange={(e) =>
                        this.setState({ notaModulo2: e.target.value })
                      }
                    />
                  </div>
                </Col>
                <Col>
                  <div className="form-group">
                    ...
                    <InputMask
                      ...
                      onChange={(e) =>
                        this.setState({ chModulo2: e.target.value })
                      }
                    />
                  </div>
                </Col>
                ...
                <Col>
                  <div className="form-group">
                    ...
                    <InputMask
                      ...
                      onChange={(e) =>
                        this.setState({ notaModulo3: e.target.value })
                      }
                    />
                  </div>
                </Col>
                <Col>
                  <div className="form-group">
                    ...
                    <InputMask
                      ...
                      onChange={(e) =>
                        this.setState({ chModulo3: e.target.value })
                      }
                    />
                  </div>
                </Col>
        ...
        <Modal
          show={this.state.modalShowGerenciarLivro}
          onHide={() => this.handlerCloseModalGerenciarLivro()}
          aria-labelledby="contained-modal-title-vcenter"
          backdrop="static"
          fullscreen="xxl-down"
        >
          <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title-vcenter">
              <h5 className="titulo">Título: Livro1</h5>
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Container>
              <div className="d-flex justify-content-center">
                <button
                  className="button"
                  onClick={() => this.handlerShowModalAssociarAluno()}
                >
                  Associar Alunos
                </button>
              </div>
              <Row>
                ...
                <Col>
                  <h4 className="text-center font-weight-bold mb-3">Folhas</h4>
                  <Accordion>
                    <Accordion.Item eventKey="0">
        ...
        <Modal
          show={this.state.modalShowRegistrarLivro}
          onHide={() => this.handlerCloseModalRegistrarLivro()}
          aria-labelledby="contained-modal-title-vcenter"
          backdrop="static"
          size="md"
          centered
        >
          <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title-vcenter">
              <h5 className="titulo">Registrar Livro</h5>
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <div className="form-group">
            ...
            <div className="form-group">
              <label htmlFor="nome">Quantidade de Folhas</label>
              <input
                type="number"
                className="form-control"
                id="qtd_folha"
                placeholder="Digite a quantidade de folhas"
                onChange={(e) => this.setState({ qtd_folha: e.target.value })}
                value={this.state.qtd_folha}
              />
        ...
        <Modal
          show={this.state.modalShowAssociarAluno}
          onHide={() => this.handlerCloseModalAssociarAluno()}
          aria-labelledby="contained-modal-title-vcenter"
          backdrop="static"
          size="md"
          centered
        >
          <Modal.Header closeButton>
            <Modal.Title id="contained-modal-title-vcenter">
              <h5 className="titulo">Associar Aluno</h5>
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
